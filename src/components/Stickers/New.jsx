...
const New = () => {
  const handleStickerPackClick = (e) => {
    console.log("Clicked on sticker pack:", e.target.alt);
    // Call your function to open the sticker pack in a modal or something
  };
      ...
      <div className="flex gap-4 flex-wrap">
        {coverStickers.map((item) => (
          <div
            ...
            key={item.id}
            onClick={handleStickerPackClick}
          >
            <img
              src={item.img}
              alt={item.title}
